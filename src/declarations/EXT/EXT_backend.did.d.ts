...
export type Metadata = {
  ...
  { 'nonfungible' : { 'metadata' : string } };
export interface MintRequest { 'to' : User, 'metadata' : string }
...
export interface erc721_token {
  ...
  'approve' : ActorMethod<[ApproveRequest], Result_5>,
  ...
  'getTokensByIds' : ActorMethod<
    [Uint32Array | number[]],
    Array<[TokenIndex, Metadata]>
  >,
  'http_request' : ActorMethod<[HttpRequest], HttpResponse>,
  'index' : ActorMethod<[TokenIdentifier__1], Result_3>,
  ...
  'supply' : ActorMethod<[TokenIdentifier__1], Result_1>,
